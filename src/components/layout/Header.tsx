...
const Header = () => (
  <header className="border-b border-slate-200 bg-white">
    <div className="mx-auto flex min-h-16 w-full max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
      <Link
        className="rounded-lg py-2 font-semibold tracking-tight text-slate-950 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-sky-700"
        href="/"
      >
        <span lang="ja">銀魂暦 × 萩</span>
        <span className="ml-2 text-xs font-medium text-slate-500">巡禮資訊</span>
      </Link>
